...
print l_option_1f
ldesc="This is a " + random.choice(l_desc_option_list_1a) + " " + random.choice(l_desc_option_list_1b) + ", illuminated only by the " + random.choice(l_desc_option_list_1c) + " glow of the " + random.choice(l_desc_option_list_1d) + " in this " + random.choice(l_desc_option_list_1e) +". The walls and floors are covered with " + random.choice(walls) + ". " + l_desc_option_f + ".%^RESET%^"
...
dexit_array = ['The sewer continues to the', 'Tunnels can be found to the', 'The horror continues to the', 'You may be able to find escape to the']
